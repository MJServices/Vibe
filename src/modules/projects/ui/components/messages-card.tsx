...
interface AssestantMessageProps {
  content: string;
  fragment: string;
  createdAt: Date;
  isActiveFragment: boolean;
...
interface FrangmentCardProps {
  fragment: Fragment;
  isActiveFragment: boolean;
  onFragmentClick: (fragment: Fragment) => void;
}

const FragmentCard = ({ fragment, isActiveFragment, onFragmentClick }: FrangmentCardProps) => {
  return (
    <button className={cn(
